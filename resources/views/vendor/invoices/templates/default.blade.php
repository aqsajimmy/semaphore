...
<head>
    <title>{{ $invoice->name }} - {{ $invoice->sequence }}</title>
    ...
    <table class="table table-items">
        ...
        <tbody>
            ...
            @if ($customData['tunai'])
                <tr>
                    <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                    <td class="text-right pl-0">Total Tunai:</td>
                    <td class="text-right pr-0">
                        {{ $invoice->formatCurrency($customData['tunai']) }}
                    </td>
                </tr>
            @endif
            @if ($customData['debit'])
                <tr>
                    <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                    <td class="text-right pl-0">Total Debit:</td>
                    <td class="text-right pr-0">
                        {{ $invoice->formatCurrency($customData['debit']) }}
                    </td>
                </tr>
            @endif
            @if ($customData['kredit'])
                <tr>
                    <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                    <td class="text-right pl-0">Total Kredit:</td>
                    <td class="text-right pr-0">
                        {{ $invoice->formatCurrency($customData['kredit']) }}
                    </td>
                </tr>
            @endif
        </tbody>
