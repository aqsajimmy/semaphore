...
<head>
    ...
    <title>Invoice-{{ $invoice->sequence }}</title>
                    ...
                    <div class="sm:text-end space-y-2">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                            ...
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                ...
                                <dd class="col-span-2 text-gray-500 dark:text-neutral-500">
                                    {{ ucwords($invoice->getCustomData()) }}</dd>
                            </dl>
                        </div>
                        <!-- End Grid -->
                    </div>
                        ...
                        @forelse($invoice->items as $item)
                            ...
                            <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
                                <div class="col-span-full sm:col-span-2">
                                    <p class="text-gray-800 dark:text-neutral-200">{{  $item->title }}</p>
                                </div>
                                <div>
                                    <p class="text-gray-800 dark:text-neutral-200">
                                        {{ $item->quantity . ' ' . $item->units }}</p>
                                </div>
                                <div>
                                    <p class="text-gray-800 dark:text-neutral-200">
                                        {{ number_format($item->price_per_unit, 0) }}</p>
                                </div>
                                <div>
                    ...
                    <div class="w-full max-w-2xl sm:text-end space-y-2">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                            ...
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                ...
                                <dd class="col-span-2 text-gray-500 dark:text-neutral-500">
                                    {{ $invoice->formatCurrency($invoice->total_amount) }}</dd>
                            </dl>
