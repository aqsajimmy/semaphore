                                    ...
                                    <td>
                                        <div class="flex gap-2">
                                            ...
                                            <x-success-button wire:loading.attr="disabled"
                                                ...
                                                <x-loading wire:target="sendWa('{{ $item->id }}')"> Proses...
                                                </x-loading>

                                            </x-success-button>
                                            <x-secondary-button loading="Proses..." wire:click.prevent="detail('{{ $item->id }}')">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="size-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <x-danger-button loading="Proses..." wire:click.prevent="destroy('{{ $item->id }}')">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="size-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
